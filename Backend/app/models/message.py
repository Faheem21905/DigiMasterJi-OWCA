...
class ChatMessageRequest(BaseModel):
    ...
    low_bandwidth: bool = Field(default=False, description="Low bandwidth mode for data saving")
...
class ChatMessageResponse(BaseModel):
    ...
    offline_mode: bool = Field(default=False, description="Whether response was generated by offline local model")
